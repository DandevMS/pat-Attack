...
const slides = [
  ...
  {
    image: "https://w0.peakpx.com/wallpaper/207/857/HD-wallpaper-artistic-pixel-art-space-moon.jpg",
    text: "Un día, un meteorito con un virus misterioso cae en el planeta, transformando a las criaturas en seres agresivos."
  },
  {
    text: "Sumergiéndonos en la naturaleza"
  },
  {
    text: "¡Último slide!"
  }
...
const Introduction = ({ onFinish }) => {
  ...
  return (
    <div className="story-container text-white " style={{ fontFamily: "Silkscreen", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <div className="image-story" style={{ marginBottom: "1rem" }}>
        {slides[currentIndex].image && (
          <img src={slides[currentIndex].image} alt={`Slide ${currentIndex}`} style={{ maxWidth: "100%", height: "auto" }} />
        )}
      </div>
      ...
      <div className="text-2xl break-words" style={{ justifyContent:"left" ,maxWidth: "80%", margin: "0 auto" }}>
        <p>
          {typedText}
        </p>
      </div>
